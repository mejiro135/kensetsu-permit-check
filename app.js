...
function showResults() {
  ...
  document.querySelector("#result-content").innerHTML = `
    ...
    ${overall.cls === "ok" ? `<div class="result-complete-message">
      <div class="mascot-frame result-complete-mascot-frame"><img class="result-complete-mascot" src="assets/tiger-mascot.png" width="1254" height="1254" alt="胸を張ったトラのキャラクター"></div>
      <div>
        <h2>チェックおつかれさまでした。</h2>
